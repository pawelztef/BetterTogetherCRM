...
+ 3 Implement basic autorization
      ...
      c) proper links should be implemented ????
                                                                                          ...
                                                                                          /* 4 First Deploy */
                                                                                          /*   phusion passenger standalone version */
                                                                                          /*   digitalocean */
                                                                                          /*   capistrano - no? */
  ...
  5 Create Group Scaffold.
  6 Associate between group and volunteer
  7 add address model
  8 associate addres  model  with user and volunter
  9 add indexes on models
  10 add necessary plugings
    pagination
  11 add prototype of navigation
     consider bootstrap theme. If it's ok implement basic styles
