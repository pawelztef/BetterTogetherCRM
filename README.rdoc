...
+ 12 add prototype of navigation
  ...
  14 add rest models
     q) dogs with assotiation to owner
     b) trainings / traings history
        -design
        -implement
        -test
     c) client with assotiation to type business/donator/or else
     d) tests 
     e) deploy

  15 Documentation/Design of Bookkeeping
