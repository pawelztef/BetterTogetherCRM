...
!!!!! Backlog !!!!!!!
  ...
  Association between volunteers volunteers_groups and memberships for monday!!!!!!!!!!!!!!!!!!!!!!
...
+ 13 Heroku First Deploy
  ...
  14 add rest models
  a   a) dogs with assotiation to owner/client
  +      -design
  ...
  +  c) client assocaition to location
     ...
     d) events with assotiation to polymorphic assotiation participators
  +     -design
        -implement
        -test
        -seed data
  ...
  15 Bakclog
     a) assets on heroku
     b) capitalize method on users nad voluneters
        remove capitalize from common helper method
     c) asside menu
    
  16 add controllers an views
        -design
        -implement
        -test
        -deploy
